...
async def handle_webhook(
    ...
    try:
        if webhook_id:
            ...
            # SDK verify_signature usually returns the response from the API
            # or raises if failed? The SDK implementation shows it calls the API.
            # We assume it returns verification status or throws.
            # Checking the SDK code: it calls POST /v1/notifications/verify-webhook-signature
            # which returns {"verification_status": "SUCCESS" | "FAILURE"}
