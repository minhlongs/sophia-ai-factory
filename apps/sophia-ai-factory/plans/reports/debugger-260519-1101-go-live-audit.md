...
✅ **Secrets inventory (49 secrets in wrangler):** All expected keys present including `BETTER_AUTH_SECRET`, `BYOK_MASTER_KEY`, `API_ENCRYPTION_KEY`, `CRON_SECRET`, `JWT_SECRET=REDACTED`. No surprise entries.
