...
> **Version:** 1.8.0 | **Status:** Production Ready | **Last Updated:** 2026-03-07
...
| Module | File | Purpose |
|--------|------|---------|
| **Tracker** | `src/lib/usage-metering/tracker.ts` | Records raw usage events to database |
...
**Response (CSV):**
```
tenant_id,feature_key,timestamp,consumed_units,request_count,tokens_input,tokens_output,license_nonce,service,action,status,response_time_ms
user-uuid,heygen.createVideo,1709251200,1,1,0,0,abc123,heygen,createVideo,success,1234
```
...
```typescript
import { trackUsage, calculateCredits, hashLicenseKey } from '@/lib/usage-metering';
