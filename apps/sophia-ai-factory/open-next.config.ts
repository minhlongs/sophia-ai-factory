...
"@opentelemetry/*", "@apm-js-collab",
"better-sqlite3", "@upstash/redis", "upstash", "uncrypto",
"@better-auth/kysely-adapter", "kysely",
// Turbopack stragglers (2026-07-10 bundle audit) — framework + client-only stores
"next", "next/dist/*",
"zustand", "redux", "@reduxjs/toolkit", "immer",
"@geist-ui/core", "geist",
"bson", "mongodb", "@mongodb-js/*",
"leaflet", "react-leaflet", "react-map-gl", "mapbox-gl",
"puppeteer-core", "playwright",
],
},
},
