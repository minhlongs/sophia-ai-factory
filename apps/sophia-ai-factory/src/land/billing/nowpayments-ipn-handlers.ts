...
import { enqueueDlqEntry, countUnresolvedDlq, markDlqExhausted, MAX_DLQ_RETRIES, type D1LikeClient } from './nowpayments-ipn-dead-letter'
...
// MAX_DLQ_RETRIES is imported from nowpayments-ipn-dead-letter (env-configurable)
...
await markDlqExhausted(db as unknown as D1LikeClient, eventId)
