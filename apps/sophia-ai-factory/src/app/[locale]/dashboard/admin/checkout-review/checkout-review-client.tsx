...
export function CheckoutReviewClient({ localePromise }: { localePromise: Promise<string> }) {
  ...
  useEffect(() => {
    localePromise.then(setLocale);
  }, [localePromise]);

  const t = useTranslations(locale ? 'admin.checkoutReview' : 'common');
                ...
                <tr key={it.order_id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        onClick={() => act(it.order_id, 'reject', t('reviewRejectedReason'))}
