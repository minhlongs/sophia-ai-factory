...
function getSceneConfigs(
  ...
  const hookTexts: Record<string, (topic: string, brand: string, tone: string, isVi: boolean) => string> = {
    welcome: (topic, brand, _tone, vi) => vi
    ...
    product: (topic, brand, _tone, vi) => vi
    ...
    seasonal: (topic, brand, _tone, vi) => vi
    ...
    promotion: (topic, brand, _tone, vi) => vi
  ...
  const bodyTexts: Record<string, (topic: string, brand: string, tone: string, isVi: boolean) => string> = {
    welcome: (topic, brand, tone, vi) => vi
    ...
    product: (topic, brand, tone, vi) => vi
    ...
    seasonal: (topic, brand, tone, vi) => vi
    ...
    promotion: (topic, brand, tone, vi) => vi
