...
import { trackReferralSignup } from "@/forest/analytics/funnel-tracking";
...
export async function POST(request: Request): Promise<NextResponse> {
 ...
 // Track referral signup — fire-and-forget, never blocks response
 trackReferralSignup(user.id, {
 referral_code: code,
