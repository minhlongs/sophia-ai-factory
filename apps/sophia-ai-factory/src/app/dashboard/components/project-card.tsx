    ...
    <Card className="flex flex-col h-full hover:shadow-md transition-shadow">
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start gap-2">
          <CardTitle className="text-lg font-semibold line-clamp-1" title={project.topic}>
            {project.topic}
          </CardTitle>
      ...
      <CardContent className="flex-1 pb-3">
        <div className="text-sm text-gray-600 line-clamp-3 bg-gray-50 p-3 rounded-md min-h-[4.5rem]">
