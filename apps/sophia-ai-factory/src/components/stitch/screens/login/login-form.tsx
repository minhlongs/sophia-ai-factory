  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-3 rounded-lg border border-zinc-700 bg-[#0F0F11] text-zinc-100 text-sm placeholder-zinc-500 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-600/60 focus:border-amber-600/60 disabled:cursor-not-allowed disabled:opacity-50"
              required
              aria-required="true"
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-10 rounded-lg border border-zinc-700 bg-[#0F0F11] text-zinc-100 text-sm placeholder-zinc-500 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-600/60 focus:border-amber-600/60 disabled:cursor-not-allowed disabled:opacity-50"
              required
              aria-required="true"
              aria-describedby={error ? 'login-error' : undefined}
              aria-invalid={error ? true : undefined}
        ...
        {/* Submit button — Stitch amber primary */}
        <button
          type="submit"
          disabled={loading}
          className="w-full h-11 inline-flex items-center justify-center rounded-lg bg-[#D97706] text-white text-sm font-medium transition-all hover:bg-[#B45309] focus:outline-none focus:ring-2 focus:ring-amber-600/60 focus:ring-offset-2 focus:ring-offset-[#18181B] disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]"
          aria-label={t('submit')}
        >
          {loading ? (
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 h-11 rounded-lg border border-zinc-700 bg-transparent text-zinc-300 text-sm font-medium transition-colors hover:bg-zinc-800/50 focus:outline-none focus:ring-2 focus:ring-amber-600/60 disabled:pointer-events-none disabled:opacity-50"
