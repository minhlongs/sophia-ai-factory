...
export function FloatingHelpButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Help panel */}
      {isOpen && (
        <div className="absolute bottom-14 right-0 w-56 rounded-xl border border-border/40 bg-background/95 backdrop-blur-lg shadow-2xl p-3 space-y-1 animate-in fade-in slide-in-from-bottom-2 duration-200">
