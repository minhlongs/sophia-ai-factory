 ...
 * - /api/auth/*   — Better Auth manages its own CSRF
 * - /api/welcome/* — Magic link flow (token is the auth)
...
const CSRF_BYPASS_PREFIXES = ['/api/auth/', '/api/welcome/', '/api/webhooks/', '/api/csp-report']
