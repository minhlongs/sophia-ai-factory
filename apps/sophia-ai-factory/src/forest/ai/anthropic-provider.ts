...
export class AnthropicProvider implements Provider {
  ...
  async chat(messages: ChatMessage[], options: ChatOptions): Promise<ChatResponse> {
    ...
    this.assertContextBudget(messages, model);
  ...
  /**
   * Ensure the requested conversation fits within the model's safe context window.
   */
  private assertContextBudget(messages: ChatMessage[], modelId: string): void {
