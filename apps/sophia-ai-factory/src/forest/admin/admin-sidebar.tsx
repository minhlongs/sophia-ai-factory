 ...
 * Layer: forest/admin (Infrastructure Orchestrators & UI; imports from @/seed)
 *
 * Provides the dedicated operator sidebar navigation for /admin/* pages,
 * including the Handover Console (/admin/handover).
 *
 * @module forest/admin/admin-sidebar
 */
...
const navigation = [
  ...
  { name: "Key Rotation", href: "/dashboard/admin/byok-rotation", icon: KeyRound },
