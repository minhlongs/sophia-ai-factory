            ...
            <div className="rounded-lg bg-muted/50 p-4 space-y-2">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                <div>
                  ...
                  <p
                    className={`font-medium ${dunningResult.allowed ? 'text-emerald-400' : 'text-red-400'}`}
                  >
                          ...
                          <td className="px-4 py-2">
                            <span
                              className={`inline-flex items-center gap-1 ${
                                h.success ? 'text-emerald-400' : 'text-red-400'
                              }`}
                            >
                              {h.success ? (
                                <CheckCircle2 className="w-3 h-3" />
                  ...
                  <tr key={ev.id} className="hover:bg-muted/20">
                    ...
                    <td
                      className={`px-4 py-2.5 text-right font-mono text-xs ${
                        ev.creditsDelta > 0 ? 'text-amber-400' : 'text-emerald-400'
                      }`}
                    >
                      {ev.creditsDelta > 0 ? '+' : ''}
                      {ev.creditsDelta}
