  ...
  return (
    <nav aria-label="Dashboard sidebar" className="flex-1 p-4 space-y-1 overflow-y-auto">
      ...
      <Link href="/dashboard/challenges" className={linkClass("/dashboard/challenges")}>
        ...
        {/* Social RNN */}
        <Link href="/dashboard/social" className={linkClass("/dashboard/social")}>
          {renderActiveIndicator("/dashboard/social")}
          <Share2 className={iconClass("/dashboard/social")} aria-hidden="true" />
          <span className="font-medium">{t('sidebar.social')}</span>
        </Link>
