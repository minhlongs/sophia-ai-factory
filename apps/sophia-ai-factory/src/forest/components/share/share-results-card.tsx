...
export function ShareResultsCard({
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden bg-zinc-900 border border-white/10 p-px">
      ...
      <div className="relative rounded-2xl bg-zinc-950/90 p-6 flex flex-col gap-4">
        {/* Header */}
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium text-white/40 uppercase tracking-widest mb-1">SOP Results</p>
            <h3 className="text-white font-semibold text-base leading-snug truncate">{sopName}</h3>
          </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-white/80 font-semibold">{percent}%</span>
          </div>
        ...
        {executionTime && (
          <p className="text-xs text-white/40">
            ...
            <span className="text-white/60">{executionTime}</span>
          </p>
        )}
        ...
        <div className="flex items-center gap-1.5 pt-1 border-t border-white/5">
          ...
          <span className="text-xs text-white/30">
            Powered by <span className="text-white/50 font-medium">Sophia AI</span>
          </span>
        </div>
      </div>
    </div>
