/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: 03b7e510bbba6bd39c2b03a0be9d944d)
// Runtime types generated with workerd@1.20260617.1 2026-03-17 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_DISTRIBUTE_ENABLED" | "IS_CONFIGURED" | "HONEYCOMB_DATASET" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "OTEL_SERVICE_NAME" | "OTEL_SAMPLERATE" | "FEATURE_PAYOS" | "OPENNEXT_VERSION">> {}
}
