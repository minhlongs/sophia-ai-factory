    ...
    <section id="workflow" className="py-20 relative bg-surface/50">
      <Container>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 -translate-y-1/2 z-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                <Card className="h-full flex flex-col items-center text-center p-6 bg-background/80 backdrop-blur-sm border-white/5 hover:border-primary/30 transition-colors">
