---
title: "Phase 1 — Database Schema for Billing"
priority: P1
status: completed
effort: 2h
...
# PHASE 1 — DATABASE SCHEMA FOR BILLING

## Overview

Create Supabase database tables for Polar billing integration, MCU tracking, and usage logging.
...
-- Subscriptions: Org members can view their subscriptions
...
-- Usage logs: Org members can view their usage
...
-- Org balances: Org members can view their balance
...
-- Billing settings: Org admins can manage
...
-- Customer feedback: Org members can submit
...
1. Create SQL migration file: `lib/supabase/migrations/004_billing_tables.sql`
...
- Migration: `lib/supabase/migrations/004_billing_tables.sql`
