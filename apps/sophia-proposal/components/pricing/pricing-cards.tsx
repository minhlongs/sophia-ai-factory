 ...
 *
 * handleCheckout is exported so pricing-section.tsx can reuse it
 * without duplicating the fetch/redirect logic.
 */

import { useState } from 'react';
import { PRICING_TIERS } from '@/lib/pricing-config';

// ── Shared checkout logic (used by PricingCards and PricingSection) ──────────

export async function handleCheckout(
  tierId: string,
  cta: string,
  setLoadingTier: (id: string | null) => void,
