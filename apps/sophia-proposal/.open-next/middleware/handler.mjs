...
var BuildId = "fsqVuqy_QbC2ARHWKtkig";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "fsqVuqy_QbC2ARHWKtkig", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "X6slyH3hEz9mH5qi1GP6f7HTVlqdC63MRNfVWZN2Hw8=", "__NEXT_PREVIEW_MODE_ID": "6f0d09a59d112dd66dc3085960a78ecf", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "a6e996bad14ef2e80a447191053fca3c0ab76cd92756f9542cc0c6c4ed19fe97", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "402e5bda7d31e564803dd15a088e35dacfd0d9bd5c2f8a8f008a99ac4ed72ab0" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/analytics/metrics/route": "/api/analytics/metrics", "/api/analytics/conversions/route": "/api/analytics/conversions", "/api/analytics/usage/route": "/api/analytics/usage", "/api/billing/portal/route": "/api/billing/portal", "/api/analytics/export/route": "/api/analytics/export", "/api/crm/callback/route": "/api/crm/callback", "/api/crm/sync/route": "/api/crm/sync", "/api/billing/subscription/route": "/api/billing/subscription", "/api/crm/connect/route": "/api/crm/connect", "/api/feedback/route": "/api/feedback", "/api/billing/checkout/route": "/api/billing/checkout", "/api/onboarding/progress/route": "/api/onboarding/progress", "/api/onboarding/status/route": "/api/onboarding/status", "/api/usage/route": "/api/usage", "/api/video/[id]/route": "/api/video/[id]", "/api/video/generate/route": "/api/video/generate", "/api/video/webhook/route": "/api/video/webhook", "/favicon.ico/route": "/favicon.ico", "/api/video/proposal/[proposalId]/route": "/api/video/proposal/[proposalId]", "/api/affiliate/clicks/track/route": "/api/affiliate/clicks/track", "/api/affiliate/content/route": "/api/affiliate/content", "/api/affiliate/content/[id]/route": "/api/affiliate/content/[id]", "/api/affiliate/programs/scrape/route": "/api/affiliate/programs/scrape", "/api/affiliate/programs/route": "/api/affiliate/programs", "/api/affiliate/programs/[id]/route": "/api/affiliate/programs/[id]", "/api/affiliate/clicks/stats/route": "/api/affiliate/clicks/stats", "/api/affiliate/content/generate/route": "/api/affiliate/content/generate", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/login/route": "/api/auth/login", "/api/auth/signup/route": "/api/auth/signup", "/api/health/route": "/api/health", "/api/proposals/[id]/route": "/api/proposals/[id]", "/api/org/route": "/api/org", "/api/proposals/generate/route": "/api/proposals/generate", "/api/raas/execute/route": "/api/raas/execute", "/api/raas/missions/[id]/route": "/api/raas/missions/[id]", "/api/health/deep/route": "/api/health/deep", "/api/raas/keys/[id]/route": "/api/raas/keys/[id]", "/api/raas/keys/route": "/api/raas/keys", "/api/proposals/route": "/api/proposals", "/api/raas/templates/route": "/api/raas/templates", "/api/raas/usage/route": "/api/raas/usage", "/api/referral/track/route": "/api/referral/track", "/api/referral/code/route": "/api/referral/code", "/api/referral/earn/route": "/api/referral/earn", "/api/referral/stats/route": "/api/referral/stats", "/api/v1/missions/[id]/route": "/api/v1/missions/[id]", "/api/templates/route": "/api/templates", "/api/v1/missions/[id]/result/route": "/api/v1/missions/[id]/result", "/api/v1/missions/[id]/cancel/route": "/api/v1/missions/[id]/cancel", "/api/raas/missions/route": "/api/raas/missions", "/api/v1/missions/route": "/api/v1/missions", "/api/webhooks/polar/route": "/api/webhooks/polar", "/(dashboard)/analytics/page": "/analytics", "/(dashboard)/billing/success/page": "/billing/success", "/(dashboard)/billing/upgrade/page": "/billing/upgrade", "/(dashboard)/proposals/[id]/page": "/proposals/[id]", "/(dashboard)/missions/page": "/missions", "/(dashboard)/proposals/new/page": "/proposals/new", "/(dashboard)/missions/[id]/page": "/missions/[id]", "/(dashboard)/templates/page": "/templates", "/(dashboard)/billing/page": "/billing", "/(dashboard)/usage/page": "/usage", "/(dashboard)/proposals/page": "/proposals", "/onboarding/page": "/onboarding", "/dashboard/page": "/dashboard", "/(dashboard)/affiliate/page": "/affiliate", "/(dashboard)/referral/page": "/referral", "/page": "/", "/(dashboard)/settings/api-keys/page": "/settings/api-keys", "/(marketing)/pricing/page": "/pricing", "/(auth)/signup/page": "/signup", "/(auth)/login/page": "/login", "/(auth)/magic-link/page": "/magic-link" };
