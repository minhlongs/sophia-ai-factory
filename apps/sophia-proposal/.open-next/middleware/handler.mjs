...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
      ...
      async function aW(a2) {
        ...
        if (!process.env.JWT_SECRET) return b2.startsWith("/api/") ? aR.Rp.json({ error: "Auth not configured" }, { status: 503 }) : aR.Rp.redirect(new URL("/status", a2.url));
  ...
  `);
      ...
      async function e(a2) {
        try {
          let b2 = process.env.JWT_SECRET ?? null;
          if (!b2) return null;
