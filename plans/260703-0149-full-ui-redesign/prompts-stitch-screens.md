...
- BASIC $29/mo: "For starters" — amber border accent, features list (10 campaigns, 3 channels, basic analytics), "Get Started" ghost button
- PREMIUM $79/mo: "Most Popular" badge in amber, highlighted card with amber border. Features (100 campaigns, all channels, advanced analytics, priority support). "Start Free Trial" primary filled button
