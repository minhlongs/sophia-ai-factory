---
description: "⚡⚡ No research. Only analyze and create an implementation plan - Args: ['task']"
---
...
1. If creating new: Create directory using `Plan dir:` from `## Naming` section, then run `node .opencode/scripts/set-active-plan.cjs {plan-dir}`
