...
2. Go to: **[https://sophia.agencyos.network](https://sophia.agencyos.network)**
...
3. **HeyGen API Key** (For AI Avatars/Video)
   - Get it here: [heygen.com](https://heygen.com)
...
- Go directly to: [https://sophia.agencyos.network/setup-wizard](https://sophia.agencyos.network/setup-wizard)
