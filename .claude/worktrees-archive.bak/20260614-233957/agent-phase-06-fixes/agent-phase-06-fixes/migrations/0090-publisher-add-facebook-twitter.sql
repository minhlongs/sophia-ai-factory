-- Migration 0090: Add facebook + twitter to publishing_channels.provider CHECK
...
-- Step 1: Create new table with extended CHECK
CREATE TABLE IF NOT EXISTS publishing_channels_new (
  id TEXT PRIMARY KEY,
  tenant_id TEXT NOT NULL,
  user_id TEXT NOT NULL,
  provider TEXT NOT NULL CHECK(provider IN ('tiktok','youtube','instagram','pinterest','linkedin','zalo','facebook','twitter')),
