...
- [x] No secrets hardcoded in wrangler.toml — JWT_SECRET=REDACTED set via CF dashboard (env var)
...
- [x] JWT_SECRET=REDACTED absence handled gracefully (503 for API, redirect to /status for pages)
