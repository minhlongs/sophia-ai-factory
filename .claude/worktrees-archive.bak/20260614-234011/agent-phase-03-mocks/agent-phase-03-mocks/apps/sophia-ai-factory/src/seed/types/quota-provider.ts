 ...
 *
 * Implementations live in `forest/quota/*` (e.g., `getEffectiveQuotaLimits` from
 * `forest/quota/quota-checker`). Composition root (route handler or job) injects
 * the implementation when calling seed APIs.
 *
 * @example
