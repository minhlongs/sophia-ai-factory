...
class TestAPIKeyFinder:
    ...
    def test_find_api_key_not_found(self, monkeypatch):
        ...
        monkeypatch.delenv('AIzaSyBQd2RoMEt3igCr7S-vy2qmZk8u3-x25go', raising=False)
        # Also clear any .env file loading by mocking the resolver
        monkeypatch.setattr(gbp, 'CENTRALIZED_RESOLVER_AVAILABLE', False)
