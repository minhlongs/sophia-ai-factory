...
| Secondary | `#E879F9` | `--color-secondary` |
| Accent/CTA | `#EA580C` | `--color-accent` |
| Background | `#FDF4FF` | `--color-background` |
| Foreground | `#86198F` | `--color-foreground` |
| Muted | `#F0EEF9` | `--color-muted` |
| Border | `#F5D0FE` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#D946EF` | `--color-ring` |

**Color Notes:** Excitement purple + urgency orange [Accent adjusted from #F97316 for WCAG 3:1]

### Typography

- **Heading Font:** Inter
- **Body Font:** Inter
- **Mood:** Friendly + Engaging typography
