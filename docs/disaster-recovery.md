...
- Required secrets: JWT_SECRET, ANTHROPIC_API_KEY, RESEND_API_KEY, POLAR_ACCESS_TOKEN, HEYGEN_API_KEY
...
3. Invalidate old JWT tokens if JWT_SECRET compromised (all users must re-login)
