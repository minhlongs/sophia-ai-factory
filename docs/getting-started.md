# Getting Started / Bat Dau Su Dung
...
> OpenRouter giup Sophia su dung tri tue nhan tao de viet kich ban video.
...
> ElevenLabs giup Sophia tao giong noi AI tu nhien cho video.
...
> HeyGen giup Sophia tao video voi nguoi trinh bay ao (AI avatar).
...
|---|---|---|
| Ket noi Telegram Bot | Connect Telegram Bot | [Huong dan Telegram Bot](./telegram-bot-guide.md) |
| Xem bang gia | View pricing tiers | [Bang Gia & Goi Dich Vu](./pricing-and-tiers.md) |
| Xu ly su co | Troubleshooting | [Xu Ly Su Co](./troubleshooting.md) |
