# Archive — Reason stubs

Files moved here on 2026-05-20 during docs harness alignment (`plans/260520-2151-docs-harness-alignment/`).

| File | Reason |
|---|---|
| `tech-debt.md` | 2026-03-27 snapshot. Closed by 2026-05 consolidation (Bundle C, prod SHA 1061cca). No longer reflects backlog. |
| `raas-license-gating.md` | 2026-03-27 design doc. License gating feature never shipped — not in current roadmap. Sophia ships full feature set per tier; no add-on licenses. |
